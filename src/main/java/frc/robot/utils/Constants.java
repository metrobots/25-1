...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 4.8; // Adjust based on your preference
    ...
    // These values should be adjusted based on your Thrifty encoder readings
  ...
  public static final class ModuleConstants {
    ...
    public static final double kWheelDiameterMeters = 0.10033; // MK4i wheel diameter
